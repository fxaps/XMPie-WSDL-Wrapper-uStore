...
class ProductionWS extends SoapClient
{
    ...
    private static $classmap = array(
        'GetProofTicketId' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProofTicketId',
        'GetProofTicketIdResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProofTicketIdResponse',
        'GetProcessTicketId' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProcessTicketId',
        'GetProcessTicketIdResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProcessTicketIdResponse',
        'DownloadProof' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\DownloadProof',
        'DownloadProofResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\DownloadProofResponse',
        'ArrayOfBase64Binary' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\ArrayOfBase64Binary',
        'SendToProduction' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\SendToProduction',
        'SendToProductionResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\SendToProductionResponse',
        'GetProductionOutputUrl' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProductionOutputUrl',
        'GetProductionOutputUrlResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProductionOutputUrlResponse',
        'GetProductionStatus' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProductionStatus',
        'GetProductionStatusResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\GetProductionStatusResponse',
        'ProductionStatus' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\ProductionStatus',
        'ArrayOfString' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\ArrayOfString',
        'SendToProductionOneCopy' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\SendToProductionOneCopy',
        'SendToProductionOneCopyResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\SendToProductionOneCopyResponse',
        'LaunchCircleProjectOrderProduct' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\LaunchCircleProjectOrderProduct',
        'LaunchCircleProjectOrderProductResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\LaunchCircleProjectOrderProductResponse',
        'TerminateCircleProjectOrderProduct' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\TerminateCircleProjectOrderProduct',
        'TerminateCircleProjectOrderProductResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ProductionWS\\TerminateCircleProjectOrderProductResponse',
    );
