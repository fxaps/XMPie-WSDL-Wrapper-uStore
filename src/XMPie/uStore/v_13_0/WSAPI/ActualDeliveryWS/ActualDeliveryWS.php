...
class ActualDeliveryWS extends SoapClient
{
    ...
    private static $classmap = array(
        'GetActualDelivery' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\GetActualDelivery',
        'GetActualDeliveryResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\GetActualDeliveryResponse',
        'ActualDelivery' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\ActualDelivery',
        'ReturnObject' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\ReturnObject',
        'CreateDelivery' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDelivery',
        'ArrayOfInt' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\ArrayOfInt',
        'CreateDeliveryResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryResponse',
        'CreateDeliveryWithDetails' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryWithDetails',
        'CreateDeliveryWithDetailsResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryWithDetailsResponse',
        'CreateDeliveryByOrderProducts' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryByOrderProducts',
        'CreateDeliveryByOrderProductsResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryByOrderProductsResponse',
        'CreateDeliveryWithDetailsByOrderProducts' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryWithDetailsByOrderProducts',
        'CreateDeliveryWithDetailsByOrderProductsResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\CreateDeliveryWithDetailsByOrderProductsResponse',
        'ManualDeliveryArrived' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\ManualDeliveryArrived',
        'ManualDeliveryArrivedResponse' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\ManualDeliveryArrivedResponse',
        'StringArray' => 'XMPieWsdlClient\\XMPie\\uStore\\v_13_0\\WSAPI\\ActualDeliveryWS\\StringArray',
    );
