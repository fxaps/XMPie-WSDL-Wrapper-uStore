...
class ArrayOfCustomizationDialValue implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uStore\v_15_0\WSAPI\CustomizationDialWS\ArrayOfCustomizationDialValue
     */
     ...
     * @return CustomizationDialValue
     */
    public function offsetGet($offset): CustomizationDialValue
    {
     ...
     */
    public function current(): CustomizationDialValue
    {
