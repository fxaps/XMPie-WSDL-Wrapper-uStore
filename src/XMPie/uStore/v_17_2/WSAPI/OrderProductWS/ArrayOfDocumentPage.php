...
class ArrayOfDocumentPage implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @return \XMPieWsdlClient\XMPie\uStore\v_17_2\WSAPI\OrderProductWS\ArrayOfDocumentPage
     */
     ...
     * @return DocumentPage
     */
    public function offsetGet($offset): DocumentPage
    {
     ...
     */
    public function current(): DocumentPage
    {
